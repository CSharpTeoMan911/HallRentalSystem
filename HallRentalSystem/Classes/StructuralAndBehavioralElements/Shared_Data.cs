...
namespace HallRentalSystem.Classes.StructuralAndBehavioralElements
{
    public class Shared_Data : ComponentBase
    {
        ...
        public static CRUD_Context<ChildQuery, string, string, string> log_in_session = new CRUD_Context<ChildQuery, string, string, string>(new LoginSessionKeyOperations());
    }
}
